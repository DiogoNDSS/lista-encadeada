class Funcionario
{
  ...
  public void inserirInicio(string nome, int idade, string telefone, double salario)
  {
    ...
    if (this.inicio == null && this.fim == null)
    {
      this.inicio = novoNo;
      this.fim = novoNo;
      System.Console.WriteLine("Insira o nome: " + this.inicio.nome);
    }
  ...
  public void inserirFim(string nome, int idade, string telefone, double salario)
  {
    ...
    if (this.inicio == null && this.fim == null)
    {
      this.inicio = no;
      this.fim = no;
      System.Console.WriteLine("Insira o nome: " + this.fim.nome);
    }
    else
    {
      this.fim.noProx = no;
  ...
  public void removerInicio()
  {
    if (this.inicio == null && this.fim == null)
    {
      System.Console.WriteLine("Uma lista vazia");
    }
    else if (this.inicio != null)
    {
      System.Console.WriteLine("Remover no: " + this.inicio.nome);
  ...
  public void removerFim()
  {
    ...
    else if (this.inicio != null)
    {
      while (noAux != null)
      {
        ...
        {
          System.Console.WriteLine("Remover no: " + noAux.noProx.nome);
